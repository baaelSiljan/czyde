(function(){
  ...
  Layout.prototype.listPreview = function() {
    var self;
    self = this;
    return this.getJSONP('https://api.github.com/repos/Baael/czyde/git/trees/30c9e1a221062e623915e24e0a57eeeb9c265041?' + Math.floor(Math.random() * 10000000), function(data) {
