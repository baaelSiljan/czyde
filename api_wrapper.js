(function(){
  ...
  Layout.prototype.listPreview = function() {
    var self;
    self = this;
    return this.getJSONP('https://api.github.com/repos/Baael/czyde/git/trees/eaf12db12b0fd278a649d864a664cf73cf9e69a7?' + Math.floor(Math.random() * 10000000), function(data) {
